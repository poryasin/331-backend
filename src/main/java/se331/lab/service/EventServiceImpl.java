...
public class EventServiceImpl implements EventService {
    ...
    @Override
    public Page<Event> getEventsAnd(String title, String description, String organizerName, Pageable page) {
        return eventDao.getEventsAnd(title, description, organizerName,page);
    }
